...
public class UserController {
     ...
     */
    @PostMapping("logout")
    public ApiResp<Boolean> logout(@Validated @RequestBody ApiReq<StringReq> req) {
        return ApiResp.ok();
    }
    ...
    public ApiResp<UserTokenVO> refreshToken(@Validated @RequestBody ApiReq<UserTokenFreshReq> req) {
        return ApiResp.ok(userService.refreshToken(req.getData()));
    }
